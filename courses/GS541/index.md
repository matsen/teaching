...
* Write a likelihood function for the binary model given two sequences that have 20 identical sites and 4 differing ones. Plot this likelihood function for a range of values containing the mean. (Note that this part of the assignment does not involve a proper tree, just two sequences evolving from one to the other.)
